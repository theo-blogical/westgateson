...
*I guess as an engineer and utilizing math since my early days, there are so many concepts fundamental in the makeup of what we use to find out how to put things together. Having something which looks like one thing yet another thing through a different view. It hasn't made me very upset. For some reason, there was a question if you could take a square root of a negative number. And of course the answer is no, because square roots are always a number times a number. However, in the 16th century, Italian mathematicians like **Rafael Bombelli** were the first to seriously work with these "imaginary numbers" while solving cubic equations, treating i=−1i = \sqrt{-1}i=−1 as a formal tool despite its oddity. Some bright mathematician decided that they would create this special imaginary number, and you knew it was imaginary because this particular number had an **i** after it, signifying it was the square root of a negative number.*

*Now, at the time when this was constructed, it was considered just sheer madness—even **René Descartes**, widely considered the brightest mind of his era in the 17th century, decried them as completely illogical and mockingly named them "imaginary" to dismiss their validity. And yet, over time, figures like **Charles Proteus Steinmetz**, a pioneering electrical engineer in the late 19th and early 20th centuries, discovered and proved that these numbers were core to understanding **alternating current (AC)** electricity through phasor analysis, making modern power systems possible. It would be impossible for us to create anything we have today without electricity that we describe through these things that are called imaginary numbers, something which seemingly makes no sense on the surface of it.*
